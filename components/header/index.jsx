    ...
    <Menubar.Root className="MenubarRoot">
      <Menubar.Menu>
        <Menubar.Trigger className="MenubarTrigger">
          <Heading>{translate(`home.title`)}</Heading>
        </Menubar.Trigger>
        <Menubar.Portal>
          <Menubar.Content
      ...
      <Menubar.Menu align="end">
        <Menubar.Trigger className="MenubarTrigger">About</Menubar.Trigger>
        <Menubar.Portal>
          <Menubar.Content
            className="MenubarContent"
            align="start"
      ...
      <Menubar.Menu>
        <Menubar.Trigger className="MenubarTrigger">Resources</Menubar.Trigger>
        <Menubar.Portal>
          <Menubar.Content
            className="MenubarContent"
            align="start"
